...
```{r install_libraries, include=FALSE, eval=FALSE}

# Each of the following libries will be loaded below.
...
Below is Plot 3's starting point (was Fig 6. in [Miller et al. 2019](https://www.sciencedirect.com/science/article/pii/S0749596X18300846)). Note that error bars aren't even provided!:
...
(n = 31), medium WMC (n = 69), and high WMC (n = 33) individuals. Serial position was broken 
down into Primacy (words 1–3), Mid (words 4–7), and Recency (words 8–10) for graphical purposes.",
             y = "Changes in Pupil Diameter (mm)",
             x = "Time (ms)") +
        # Adjust/Relabel x axis values to make more sense to reader
        scale_x_continuous(breaks = c(0, 2, 4, 6, 8, 10, 12, 14),
...
```{r plot3_fun_print, fig.align='center', layout="l-screen-inset shaded"}
